...
import {getSolaminterFee, setSolaminterFee } from '../../utils/assets';
...
export const AdminView = () => {
  ...
  const data = [
    { year: 'OCT 2020', value: 3 },
    { year: 'NOV', value: 4 },
    { year: 'DEC', value: 8 },
    { year: 'JAN 2021', value: 5 },
    { year: 'FEB', value: 12 },
    { year: 'MAR', value: 6 },
    { year: 'APR', value: 7 },
    { year: 'MAY', value: 9 },
        ...
        <>
          ...
          <Row>
            <Col span={width > 992 ? 12 : 24}>
              <ChartView key={1} title="Total Fees Collected (in SOL)" data={data} />
            </Col>
            <Col span={width > 992 ? 12 : 24}>
              <ChartView key={2} title="Total NFTs minted" data={data} />              
            </Col>
          </Row> 
          <Row>
